...
{
    public class AutoTopUpViewModel : BaseViewModel, ITopupViewModel
    {
        #region Fields
        ...
        {
            await NavigationServiceDep.NavigateToAsync<PayInStoreViewModel>(Account);
        });
